...
class Settings(BaseSettings):
    ...
    prescore_budget_multiplier: int = 10  # PRESCORE_BUDGET_MULTIPLIER — a user's daily Tier-1 allowance = PLAN_LIMITS["finals_daily"] × this (PRO: 50 × 10 = 500 prescores/day). Prescores are ~1/10th the price of a final and were previously charged AS finals whenever they ran on Anthropic (OpenAI down), which spent a PRO user's whole day 15 minutes after 00:00 UTC. 0 = prescores unbounded per user (platform caps still apply).
