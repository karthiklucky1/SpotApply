...
_ROLE_TERM_ALIASES = {
    ...
    "frontend": ("front end", "front-end", "react", "angular", "vue",
                 "javascript", "ui engineer", "web developer"),
    "react": ("frontend", "front end", "front-end", "javascript"),
    "angular": ("frontend", "front end", "front-end"),
    "vue": ("frontend", "front end", "front-end"),
    "full stack": ("fullstack", "full-stack"),
    "applied scientist": ("research scientist", "research engineer", "applied science"),
    # "SDE" is the dominant title at Amazon/Flipkart/much of Indian tech — a
    # "Software Engineer" user must receive "SDE II" postings and vice versa.
    ...
    "sre": ("site reliability", "devops", "infrastructure engineer"),
    "site reliability": ("sre", "devops"),
    "data engineer": ("etl", "data platform", "analytics engineer"),
    ...
    "qa": ("quality assurance", "test engineer", "sdet", "quality engineer"),
    "quality assurance": ("qa", "test engineer", "sdet"),
    "sdet": ("qa", "test engineer", "quality assurance"),
    "security engineer": ("infosec", "cybersecurity", "appsec", "application security"),
    "cybersecurity": ("security engineer", "infosec"),
    "mobile": ("ios", "android", "react native", "flutter"),
    "ios": ("mobile", "swift"),
    "android": ("mobile", "kotlin"),
    # Non-tech department users (nursing, finance) follow the same routing path.
    "registered nurse": ("rn", "nurse", "nursing"),
    "nurse": ("rn", "registered nurse", "nursing"),
    "rn": ("registered nurse", "nurse", "nursing"),
    "accountant": ("accounting", "staff accountant"),
